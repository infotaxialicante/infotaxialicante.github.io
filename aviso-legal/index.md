...
Los textos, elementos gráficos, logotipos, diseño, estructura y código desarrollados específicamente para InfoTaxi Alicante pertenecen a su titular, salvo aquellos elementos sobre los que existan derechos de terceros.
...
## 4. Información y exclusión de responsabilidad
...
### Paradas y mapas
La información relativa a la ubicación de paradas de taxi y otros elementos cartográficos se proporciona con finalidad informativa y puede estar sujeta a cambios o errores. La representación cartográfica no constituye una garantía de que una parada, acceso, ubicación o recorrido se encuentre disponible o sea exactamente igual en el momento de la consulta.

### Normativa y otra información
La información relativa a normativa, procedimientos, tarifas u otras cuestiones del sector tiene carácter divulgativo. La existencia de un contenido en InfoTaxi Alicante no implica que este sustituya a la normativa vigente ni a la información proporcionada por las administraciones u organismos competentes.

### Enlaces externos
El sitio web puede incluir enlaces a páginas, mapas, herramientas o servicios pertenecientes a terceros. InfoTaxi Alicante no controla los contenidos, disponibilidad, funcionamiento, condiciones de uso ni políticas de privacidad de dichos servicios externos y no asume responsabilidad por ellos. 
...
Para consultas, sugerencias, comunicaciones sobre el funcionamiento del sitio web o cuestiones relacionadas con sus contenidos:
* **Consultas generales:** [contacto@infotaxialicante.es](mailto:contacto@infotaxialicante.es)
* **Participaciones y colaboraciones:** [colaboraciones@infotaxialicante.es](mailto:colaboraciones@infotaxialicante.es)
