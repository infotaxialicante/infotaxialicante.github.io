...
const destinos = [
    ...
    { nombre: "Alquería de Aznar", distancia: 68 },
    ...
    { nombre: "Ráfol de Almunia", distancia: 96 },
    ...
    { nombre: "Sanet y Negrals", distancia: 94 },
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calcularTarifa() {
        ...
        resultadoDiv.innerHTML = `💰 Precio estimado: <span style="color:#0a5b2e;">${total.toFixed(2)} €</span>`;
        ...
        // Mostrar siempre la bajada de bandera aplicada
        ...
        if (tieneSuplemento) {
            statusHTML += `<span class="status-suplemento">➕ Suplemento especial (+3 €) aplicado</span>`;
        }
