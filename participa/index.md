...
Si quieres participar, el procedimiento es el siguiente:

---

### 1. Solicita participar

Antes de enviar ningún artículo, escribe a:

[colaboraciones@infotaxialicante.es](mailto:colaboraciones@infotaxialicante.es)

En el correo deberás indicar que deseas participar en el portal y dejar constancia de que has leído y comprendido las condiciones de esta sección Participa.

**No se admitirán textos enviados directamente sin seguir este procedimiento.**

Si tienes cualquier duda sobre el proceso de participación, puedes consultarla en esa misma dirección de correo electrónico.
...
### 3. Completa el formulario y envía tu propuesta

El formulario solicitará únicamente los datos necesarios para gestionar la participación y las autorizaciones correspondientes.

De forma general, se solicitarán:

- Nombre y apellidos.
- Dirección de correo electrónico.
- Alias o nombre con el que deseas aparecer públicamente, si quieres utilizar uno distinto de tu nombre.

Una vez cumplimentado el formulario, deberás responder en el mismo hilo de correo y adjuntar:

- El artículo o texto propuesto.
- Una única imagen para acompañarlo, de forma opcional.

El texto puede enviarse en un formato habitual que permita su lectura y edición. Si fuera necesario utilizar un formato concreto, se indicará en la respuesta correspondiente.
...
El editor podrá rechazar cualquier propuesta que no considere adecuada para el portal, sin que exista obligación de justificar editorialmente dicha decisión.
...
### 6. Valoración y edición

Una vez recibido el artículo, InfoTaxi Alicante lo revisará y decidirá si resulta adecuado para su publicación.

No existe ninguna obligación de publicar los textos recibidos, aunque cumplan formalmente los requisitos.

Si el artículo se considera de interés para los lectores, comenzará un proceso de edición destinado exclusivamente a mejorar su presentación y comprensión. Este proceso podrá incluir, entre otras cuestiones:

- Correcciones ortográficas y gramaticales.
- Ordenación o estructuración de ideas.
- Mejoras de redacción.
- Ajustes de formato.
- Adaptaciones necesarias para la correcta presentación del contenido en la web.
- Mejoras orientadas a su correcta comprensión y posicionamiento en buscadores (SEO).

La edición no supone que el portal adquiera la autoría del texto ni sus derechos de propiedad intelectual.

---

### 7. Autorización definitiva para publicar

Una vez finalizado el proceso de edición, recibirás en el mismo hilo de correo electrónico el texto editado y, cuando corresponda, la imagen que acompañará a la publicación.

En ese momento podrás revisar el resultado.

El artículo solo será publicado cuando exista una manifestación inequívoca de tu consentimiento para su publicación en la versión definitiva que te haya sido remitida.

La utilización del mismo hilo de correo durante todo el proceso tiene como finalidad mantener la trazabilidad de las comunicaciones y de las autorizaciones concedidas.

Si no autorizas la publicación, el contenido no será publicado.

---

### 8. Autoría y nombre de publicación
...
### 10. Una participación basada en el respeto
...
Si eres mayor de 18 años, has leído esta sección y quieres presentar una propuesta, escribe a:

[colaboraciones@infotaxialicante.es](mailto:colaboraciones@infotaxialicante.es)

Indica claramente que deseas participar y que has leído las condiciones de esta sección.

A partir de ahí, te indicaremos los siguientes pasos.