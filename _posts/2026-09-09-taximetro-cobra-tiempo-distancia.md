---
layout: post
title: "El taxímetro, ¿cobra por tiempo o por velocidad?"
date: 2026-09-09 19:00:00 +0100
author: "InfoTaxi Alicante"
categories: [tarifas-y-precios]
tags: [taxímetro, curiosidades]
...
Paremos aquí la escena para intentar entender un concepto clave: **la velocidad de arrastre** (también llamada *velocidad de cambio*).

---

### ¿Qué es la velocidad de arrastre?

Podríamos definir la velocidad de arrastre como el límite exacto en el que el taxímetro conmuta su modo de tarificación. 

La pregunta obvia es: ¿cuál es esa velocidad límite? Aquí no existe una respuesta universal, pero sí aritmética. El cálculo tiene su propia fórmula (saquemos punta al lapicero):

> **Velocidad de arrastre (km/h) = Precio por hora de espera (€/h) / Precio por kilómetro recorrido (€/km)**

#### Un ejemplo práctico

Vamos a asumir que el precio de una hora de espera es de **20 €** y el precio de un kilómetro recorrido es de **1,50 €**:

> **20 €/h / 1,50 €/km = 13,33 km/h**

Esa sería la velocidad de arrastre para esa tarifa concreta (ya que tanto el precio por hora como el precio por kilómetro cambian según la tarifa correspondiente):

* **Por debajo de 13,33 km/h:** El vehículo rueda muy despacio o está parado → El taxímetro tarifica por **tiempo**.
* **Por encima de 13,33 km/h:** El vehículo fluye con normalidad → La **distancia** manda.
